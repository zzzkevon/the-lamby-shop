            ...
            {isOpen && (
                <div className="absolute right-0 bg-main rounded p-0 w-24">
                    <ul className="flex flex-col text-2xl">
                        <li className="p-1 hover:bg-gray-100 cursor-pointer" onClick={() => handleRoleChange('guest')}>
                            Guest View
                        </li>
                        <li className="p-1 hover:bg-gray-100 cursor-pointer" onClick={() => handleRoleChange('customer')}>
                            Customer View
                        </li>
                        <li className="p-1 hover:bg-gray-100 cursor-pointer" onClick={() => handleRoleChange('admin')}>
                            Admin View
                        </li>
                    </ul>
                </div>
