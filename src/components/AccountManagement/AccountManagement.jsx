...
const AccountManagement = () => {
  return (
    ...
    <div className="main-bg">
      ...
      {/** change email button */}
      <a href='/update-email'
        className="w-[20vw] flex items-center justify-center mx-auto h-24 bg-red-900 text-white just-another-hand rounded-md sm:text-lg md:text-xl lg:text-4xl xl:text-4xl">
          Update email
      </a>
      <br/>
      <br/>
