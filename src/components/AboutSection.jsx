    ...
    <div className='main-bg just-another-hand px-8 text-5xl ' style={{
      ...
      <div>
        <div className={`mt-12 mb-8 justify-center items-center flex`}>
          ...
          <h1 className='header-font header-format text-7xl py-4 mt-8 px-8'>ABOUT ME</h1>
          <div className={`w-20 bg-cover`}>
            <img src={star} alt='star' className={`object-cover block w-full transition-all duration-300 ease-in-out ${imageHeightClass}`} />
          </div>
        </div>
      ...
      <center> <p className={`w-[500px] justify-center items-center flex`}>{aboutText}</p></center>
      <div className={`mt-14 mb-8 justify-center items-center flex`}>
          <div className={`w-20 bg-cover`}>
            <img src={star} alt='star' className={`object-cover block w-full transition-all duration-300 ease-in-out ${imageHeightClass}`} />
          </div>
          <h1 className='header-font header-format text-7xl py-4 mt-8 px-8'>MISSION STATEMENT</h1>
          <div className={`w-20 bg-cover`}>
            <img src={star} alt='star' className={`object-cover block w-full transition-all duration-300 ease-in-out ${imageHeightClass}`} />
          </div>
        </div>
          <center> <p className={`w-[500px] justify-center items-center flex`}>{missionText}</p></center>
      </div>
      ...
      <div className={`justify-center items-center flex`}>
          ...
          <h1 className='header-font header-format text-7xl py-4 mt-12 px-8 mb-8'>SOCIALS</h1>
          <div className={`w-20 bg-cover`}>
            <img src={star} alt='star' className={`object-cover block w-full transition-all duration-300 ease-in-out ${imageHeightClass}`} />
          </div>
        </div>
