...
function AdminManageInventory() {
  ...
  const fetchItems = async (type = "all") => {
    try {
      ...
      let filtered = type === "all" ? data : data.filter(item => item.type === type);
  ...
  return (
    <div className={`flex justify-center items-center flex-col main-bg just-another-hand 4xl`}>
      ...
      {/* Category buttons */}
        ...
        <p className="text-2xl header-font font-bold mb-4 tracking-wider whitespace-pre mt-2">Carousel 1</p>
