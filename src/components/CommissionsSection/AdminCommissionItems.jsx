    ...
    <>
      <div className="w-full border border-gray-300 rounded overflow-hidden mb-2 just-another-hand text-3xl">
        <div className="flex justify-between">
          ...
          >
            <div className="flex w-1/4" data-testid="commission-id">
              Id: {id}
            </div>
            {/* 
            ...
            <div className="flex w-1/2" data-testid="client-name">
              ...
              Client Name:{" "}
              {clientName && clientName.length > 1 ? clientName : "N/A"}
            </div>
            <div className="flex w-1/4" data-testid="commission-date">
              Date: {formattedDate(createdAt)}
            </div>
            <div className="flex w-1/4" data-testid="commission-status">
        ...
        {isOpen && (
          <>
            <div
              className="grid grid-cols-2 block p-2 bg-white border-t border-gray-300 text-2xl"
            ...
            >
              <div>
                ...
                <button
                  ...
                  data-testid="delete-commission-button"
                >
                  Delete Commission
                </button>
              </div>
